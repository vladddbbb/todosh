...
Нужен предустановленный docker. После перехода в директорию проекта необходимо ввести в консоли `docker-compose up`, для отключения контейнера - `docker-compose down`.
